        ...
        linha.innerHTML = `
            ...
            <td>
                ...
                <button
                    ...
                    onclick="excluirProfessor(${professor.codProf})"
                >
                    🗑️ Excluir
                </button>
            </td>
...
async function excluirProfessor(codProf) {
    ...
    try {
        ...
        if (resposta.ok) {
            ...
            let mensagemErro = "Erro desconhecido ao excluir.";
            try {
                const resultado = await resposta.json();
                if (resultado.detail) {
                    mensagemErro = typeof resultado.detail === 'string' ? resultado.detail : "Erro nos dados enviados.";
                }
            } catch (e) {
                // Se a API não retornar JSON no erro
            }
        ...
        alert("Não foi possível conectar ao servidor para excluir o professor.");
    }
}